...
permalink: /nrimeet/EULA/
comments: false
---

Last updated March 1, 2024

Welcome to NRI Meet End User License Agreement. This is a contract between you and Emwave Technologies (as defined further below) and we want you to know yours and our rights before you use the NRI Meet website or application (NRI Meet or the “App” or "Licensed Application"). Please take a few moments to read these Terms before enjoying the App, because once you access, view or use the App, you are going to be legally bound by these Terms (so probably best to read them first!).
...
5. USE OF DATA
   You acknowledge that Licensor will be able to access and adjust Your downloaded Licensed Application content and Your personal information, and that Licensor's use of such material and information is subject to Your legal agreements with Licensor and Licensor's privacy policy: https://emwavetech.com/nrimeet/privacy-policy/index.html .
