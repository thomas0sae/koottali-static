...
<html lang="en">
  <head>
    ...
    <title>Koottali App Privacy Policy</title>
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-Z9LKZ0B57Y"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-Z9LKZ0B57Y');
</script>  
</head>
  ...
  <body>
    <div class="main__container">
      <div class="logo">
        <img src="../../assets/images/ktnew.svg" alt="" />
      </div>
      <h1 class="main__title">Koottali App Privacy Policy</h1>
